...
# Test 9:
    sequence = [45, 84, 32, 70, -10, 40, 27, 10, 402, 30, 50, 302, 11]
    threshold = 28
    expected = 9
    actual = count_items_bigger_than(sequence, threshold)
    print()
    ...
    # Test 10:
    sequence = [-145, -84, 32, 70, -10, -40, 30, -49]
    threshold = -50
    expected = 6
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11
    expected = 3
    actual = count_positive_sines([6, 24, 46, 353, 202, 131, 49])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 1126
    actual = sum_first_n([18, -30, 780, 55, 303, 3284, 423, 0, 1321], 5)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 408456
    actual = sum_first_n([4328, 32498, 4329, 487, 32498, 324988, 9238, 92, 92, -234], 7)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
